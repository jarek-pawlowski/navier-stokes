...
sys.set_parameters(timestep=dt, viscosity=viscosity_mu, density=density_rho, bulk_viscosity=viscosity_dzeta)
...
solver.setup_variational_problem_c()
solver.setup_solver()
...
u, p, r = values.get_actual()
plot.plot_velocity(u, values.u_geometry, scaling=200.)
