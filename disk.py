...
bc.set_velocity_marker(V, ft, 2, velocity = (1.,0.))  # velocity on the left side
bc.set_velocity_marker(V, ft, 3, velocity = (1.,0.))    # pressure on the right side 
bc.set_velocity_marker(V, ft, 4, velocity = (1.,0.))  # velocity on the top/bottom sides
